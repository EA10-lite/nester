            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2">
                ...
                >
                    ...
                    {positions.length === 0 ? (
                        <EmptyState
                            icon={Vault}
                            title="Welcome to Nester!"
                            description="Start earning yield on your stablecoins."
                        >
                            <div className="inline-block rounded-full border border-black/15 bg-white p-[3px] shadow-lg">
                                <Link
                                    href="/dashboard/vaults"
                                    className="inline-flex min-h-11 items-center rounded-full bg-linear-to-r from-[#0a0a0a] to-[#1a1a2e] px-6 py-2.5 text-sm font-medium text-white transition-all hover:from-[#1a1a2e] hover:to-[#0a0a0a]"
                                >
                ...
                {fetchErrorStatus != null ? (
                    ...
                    >
                        <DashboardContent
                            ...
                            positions={positions}
                            onWithdraw={setSelectedPosition}
                        />
                    </ErrorBoundary>
                )}
            </main>
